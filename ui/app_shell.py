    ...
    with sidebar_container:
        ...
        st.markdown(
            ...
            <div class="sidebar-app-meta">
              ...
              <div class="sidebar-app-subtle">Version: September 2026 · <a href="https://forms.office.com/Pages/ResponsePage.aspx?id=GvcJkLbBVUumZQrrWC6V07d2jCu79C5FsfEZJPZEfZxUNVlIVDRNNVBQVEgxQVFXNEM5VldUMkpXNS4u" target="_blank">Feedback</a></div>
            </div>
            """,
            unsafe_allow_html=True,
        )
